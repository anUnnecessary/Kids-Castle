        ...
        <>
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    ...
                    <a className="link link-hover">Toy robots</a>
                </div>
            ...
            <footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className="items-center grid-flow-col">
                    ...
                    <p>Kid Castle Limited<br />Providing reliable tech since 2015</p>
                </div>
                ...
                <section className="text-gray-600 body-font">
                    <div className="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
                        <div className="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
                            <h2 className="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Kids Castle Limited</h2>
                            <h1 className="md:text-3xl text-2xl font-medium title-font text-gray-900">Choose your own toy for your kids</h1>
                        </div>
                        <div className="flex md:ml-auto md:mr-0 mx-auto items-center flex-shrink-0 space-x-4">
                            ...
                            <button className="bg-gray-100 inline-flex py-3 px-5 rounded-lg items-center hover:bg-gray-200 focus:outline-none">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" classNameName="w-6 h-6" viewBox="0 0 305 305">
                                ...
                                <span className="ml-4 flex items-start flex-col leading-none">
                                    <span className=" text-gray-600">Download on the</span>
